...
export default function CartDrawer({
  ...
  const buildOrderText = () => {
    ...
    return [
      ...
      `📝 ملاحظات خاصة: ${customer.notes || "لا توجد ملاحظات"}`,
      "",
      "═══════════════════════",
      "🛒 قائمة المنتجات",
      "═══════════════════════",
      ...
      "",
      "═══════════════════════",
      `📦 عدد القطع الإجمالي: ${cartCount} قطعة`,
      `💰 الإجمالي: ${formatIQD(total)}`,
      "",
      "═══════════════════════",
      "🚚 معلومات التسليم",
      "نوع الطلب: التوصيل للعنوان",
      "طريقة الدفع: كاش عند الاستلام",
      "",
      "═══════════════════════",
      "",
      "✨ شكراً لتفضلكم مطعم الربيع ✨",
      "🙏 نتمنى لكم عافية وشهية",
      "💚 تابعونا على جميع القنوات",
    ].join("\n");
  };
